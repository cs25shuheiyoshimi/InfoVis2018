function Isosurfaces( volume, isovalue, screen, d_color)
{
    ...
    //var m_color = new THREE.Color().setHex( cmap[ isovalue ][1] );
    var m_color = new THREE.Color( d_color );
